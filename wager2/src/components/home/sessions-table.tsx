        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="w-24 text-center">Games</TableHead>
            ...
            {loading && sessions.length === 0 ? (
              ...
              sessions.map((session) => (
                ...
                >
                  ...
                  <TableCell className="capitalize">{session.users}</TableCell>
                  <TableCell className="text-center">
                    {session.gameSessionCount}
                  </TableCell>
                  <TableCell>{formatDate(session.started)}</TableCell>
                  <TableCell>
                    {session.isActive ? (
